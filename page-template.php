<?
  ...
  $title = "Page Template"; // this is for <title>
  $page_title = "This is the master page template"; // This is for breadcrumbs if I want a custom title other than the default
  $page_subheading = "This is the subheading"; // This is the subheading
  $addCSS = "master-page-template"; //custom CSS for this page only
...
<div class="container">
  ...
  <section>
    <hgroup>
      <h1>Master Page Template Headline</h1>
      <h2><?php echo $page_subheading; ?></h2>
    </hgroup>
    <p>Insert some components and shit</p>
